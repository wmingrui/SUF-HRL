...
from sufh_rl.datasets import PotsdamMulticlassDataset
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Evaluate released SUF-HRL checkpoint on Potsdam."
    )
...
def main():
    ...
    metrics["protocol"] = "Potsdam 6-class validation"
